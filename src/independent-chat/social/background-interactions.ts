/**
 * 大注释：Background interaction module.
 * Generates and schedules character interactions that are not directly user-triggered.
 */
...
import { createDefaultCharacterPlan, saveState, state } from '../core/state';
import type {
