/**
 * 大注释：Moment visibility module.
 * Calculates moment visibility scope, allow lists, and display labels.
 */
import { state } from '../core/state';
import type { CharacterProfile, MomentEntry, MomentVisibility, MomentVisibilityMode, TimelineSourceRef } from '../core/types';
