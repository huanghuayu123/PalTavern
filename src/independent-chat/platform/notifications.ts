/**
 * 大注释：Notification module.
 * Handles browser notification permission, privacy text, and local notification sending.
 */
import type { CharacterProfile, NotificationPrivacy } from '../core/types';
import {
